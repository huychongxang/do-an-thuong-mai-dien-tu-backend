                        ...
                        <div class="header-cart col-md-3  col-sm-4">
                            <div class="cart-wrapper">
                                <a href="javascript:void(0)" class="btn cart-btn default-btn">
                                    ...
                                    <span><b> cart: </b></span> <span
                                            class="blue-color"> <strong> (02 items) </strong> </span>
                            ...
                            <div class="collapse navbar-collapse no-padding" id="product-menu">
                                <ul class="nav navbar-nav">
                                    ...
                                    <li class="dropdown mega-dropdown">
                                        <a href="#" class="dropdown-toggle" data-toggle="dropdown">Kids Cloth <span
                                                    class="caret"></span></a>
                                                ...
                                                <div class="tab-content light-bg">
                                                    <div class="tab-pane fade" id="all">
                                                        <div class="block-bg">
                                                            <div class="col-md-3 col-sm-6  menu-block">
                                                                <div class="sub-list">
                                                                    <h2 class="title-2 sub-title-small">Shop by
                                                                        Category</h2>
                                                                    <ul>
                                                                        <li>
                                                                            <i class="fa fa-angle-right pink-color"></i>
                                                                            <a href="#">ShirtsT-Shirts</a></li>
                                                                        <li>
                                                                            <i class="fa fa-angle-right pink-color"></i>
                                                                            <a href="#">Pajamas</a></li>
                                                                        <li>
                                                                            <i class="fa fa-angle-right pink-color"></i>
                                                                            <a href="#">Onesies & Rompers</a></li>
                                                                        <li>
                                                                            <i class="fa fa-angle-right pink-color"></i>
                                                                            <a href="#">Party Wear</a></li>
                                                                        <li>
                                                                            <i class="fa fa-angle-right pink-color"></i>
                                                                            <a href="#">Kurta & Dhoti Sets</a></li>
                                                                        <li>
                                                                            <i class="fa fa-angle-right pink-color"></i>
                                                                            <a href="#">Night Wear</a></li>
                                                                        <li>
                                                                            <i class="fa fa-angle-right pink-color"></i>
                                                                            <a href="#">Inner Wear</a></li>
                                                                        <li>
                                                                            <i class="fa fa-angle-right pink-color"></i>
                                                                            <a href="#">Theme Costumes</a></li>
                                                                    </ul>
                                                                </div>
                                                            </div>
                                                            <div class="col-md-3 col-sm-6  menu-block">
                                                                <div class="sub-list">
                                                                    ...
                                                                    <ul>
                                                                        <li>
                                                                            <i class="fa fa-angle-right pink-color"></i>
                                                                            <a href="#">2 to 4 years</a></li>
                                                                        <li>
                                                                            <i class="fa fa-angle-right pink-color"></i>
                                                                            <a href="#">2 to 6 years</a></li>
                                                                        <li>
                                                                            <i class="fa fa-angle-right pink-color"></i>
                                                                            <a href="#">6 to 8 years</a></li>
                                                                        <li>
                                                                            <i class="fa fa-angle-right pink-color"></i>
                                                                            <a href="#">8 to 10 years</a></li>
                                                                        <li>
                                                                            <i class="fa fa-angle-right pink-color"></i>
                                                                            <a href="#">10+ years</a></li>
                                                                        <li>
                                                                            <i class="fa fa-angle-right pink-color"></i>
                                                                            <a href="#">2 to 4 years</a></li>
                                                                        <li><a href="#"> <strong> Combo
                                                                                    Packs</strong> </a></li>
                                                                        <li><a href="#"> <strong> On Sale- Boys
                                                                                    Clothes </strong> </a></li>
                                                                        <li><a href="#"> <strong> On Sale- Girls
                                                                                    Clothes </strong> </a></li>
                                                                    </ul>
                                                                </div>
                                                            </div>
                                                            ...
                                                            <div class="col-md-3 col-sm-6  menu-block menu-block-img no-padding">
                                                                <div class="title-wrap">
                                                                    ...
                                                                    <h3 class="pink-color">Up To <strong>
                                                                            30% </strong> Off</h3>
                                                                    <hr class="dash-divider-small">
                                                                    <a href="#" class="blue-color title-link"> Shop
                                                                        Now <i class="fa fa-caret-right"></i> </a>
                                                                </div>
                                                            </div>
                                                        </div>
                                                    </div>
                                                    ...
                                                    <div class="tab-pane fade" id="specials">
                                                        <div class="block-bg">
                                                            <div class="col-md-3 col-sm-6">
                                                                <div class="product-details">
                                                                    <div class="product-media">
                                                                        ...
                                                                        <img alt="product-img"
                                                                             src="{{asset('web/assets/img/product/product1.png')}}">
                                                                        <div class="product-new">
                                                                            <div class="blue-new-tag new-tag">
                                                                                <a href="#"
                                                                                   class="funky-font">New</a>
                                                                            </div>
                                                                        </div>
                                                                        <div class="product-overlay">
                                                                            <a href="#"
                                                                               class="addcart blue-background fa fa-shopping-cart"></a>
                                                                            <a href="#"
                                                                               class="likeitem green-background fa fa-heart"></a>
                                                                            <a href="#product-preview"
                                                                               data-toggle="modal"
                                                                               class="compare pink-background fa fa-eye"></a>
                                                                        </div>
                                                                    </div>
                                                                    <div class="product-content">
                                                                        <div class="rating">
                                                                        ...
                                                                        <div class="product-name">
                                                                            <p><a href="#">Babyhug Frock Style Top
                                                                                    And Leggings</a></p>
                                                            ...
                                                            <div class="col-md-3 col-sm-6">
                                                                <div class="product-details">
                                                                    <div class="product-media">
                                                                        ...
                                                                        <img alt="product-img"
                                                                             src="{{asset('web/assets/img/product/product2.png')}}">
                                                                        <div class="product-overlay">
                                                                            <a href="#"
                                                                               class="addcart blue-background fa fa-shopping-cart"></a>
                                                                            <a href="#"
                                                            ...
                                                            <div class="col-md-3 col-sm-6">
                                                                <div class="product-details">
                                                                    <div class="product-media">
                                                                        ...
                                                                        <img alt="product-img"
                                                                             src="{{asset('web/assets/img/product/product3.png')}}">
                                                                        <div class="product-new">
                                                            ...
                                                            <div class="col-md-3 col-sm-6">
                                                                <div class="product-details">
                                                                    <div class="product-media"><span
                                                                                class="hover-image white-bg">                                                                <img
                                                                                    alt=""
                                                                                    src="{{asset('web/assets/img/product/cat-7.png')}}">                                                            </span>
                                                                        <img alt="product-img"
                                                                             src="{{asset('web/assets/img/product/product4.png')}}">
                                    ...
                                    <li class="dropdown">
                                        <a href="#" class="dropdown-toggle" data-toggle="dropdown" role="button"
                                           aria-haspopup="true">Gifts <span class="caret"></span></a>
                                        <ul class="dropdown-menu ">
                                            ...
                                            <div class="block-bg  light-bg">
                                                <div class="col-md-3 col-sm-6  menu-block">
                                                    <div class="sub-list">
                                                        ...
                                                        <ul>
                                                            <li><i class="fa fa-angle-right pink-color"></i> <a
                                                                        href="categories-listing.html">Category
                                                                    Listing</a></li>
                                                            <li><i class="fa fa-angle-right pink-color"></i> <a
                                                                        href="product-grid-fullwidth.html">Category
                                                                    Grid View Full Width</a></li>
                                                            <li><i class="fa fa-angle-right pink-color"></i> <a
                                                                        href="product-grid-rightsidebar.html">Category
                                                                    Grid View Right Sidebar</a></li>
                                                            <li><i class="fa fa-angle-right pink-color"></i> <a
                                                                        href="product-grid-leftsidebar.html">Category
                                                                    Grid View Left Sidebar</a></li>
                                                            <li><i class="fa fa-angle-right pink-color"></i> <a
                                                                        href="product-list-fullwidth.html">Category
                                                                    List View Full Width</a></li>
                                                            <li><i class="fa fa-angle-right pink-color"></i> <a
                                                                        href="product-list-rightsidebar.html">Category
                                                                    List View Right Sidebar</a></li>
                                                            <li><i class="fa fa-angle-right pink-color"></i> <a
                                                                        href="product-list-leftsidebar.html">Category
                                                                    List View Left Sidebar</a></li>
                                                        </ul>
                                                    </div>
                                                </div>
                                                <div class="col-md-3 col-sm-6  menu-block">
                                                    <div class="sub-list">
                                                        ...
                                                        <ul>
                                                            <li><i class="fa fa-angle-right pink-color"></i> <a
                                                                        href="product-single-fullwidth.html">Single
                                                                    Product Full Width</a></li>
                                                            <li><i class="fa fa-angle-right pink-color"></i> <a
                                                                        href="product-single-hover.html">Single
                                                                    Product Hover</a></li>
                                                            <li><i class="fa fa-angle-right pink-color"></i> <a
                                                                        href="product-single-rightsidebar.html">Single
                                                                    Product Right Filter</a></li>
                                                            <li><i class="fa fa-angle-right pink-color"></i> <a
                                                                        href="product-single-leftsidebar.html">Single
                                                                    Product Left Filter</a></li>
                                                        </ul>
                                                    </div>
                                                </div>
                                                <div class="col-md-3 col-sm-6  menu-block">
                                                    <div class="sub-list">
                                                        ...
                                                        <ul>
                                                            ...
                                                            <li><i class="fa fa-angle-right pink-color"></i> <a
                                                                        href="check-out.html">Checkout</a></li>
                                                            <li><i class="fa fa-angle-right pink-color"></i> <a
                                                ...
                                                <div class="col-md-3 col-sm-6  menu-block">
                                                    <div class="sub-list">
                                                        ...
                                                        <ul>
                                                            ...
                                                            <li><i class="fa fa-angle-right pink-color"></i> <a
                                                                        href="account-info.html"> Account
                                                                    Information </a></li>
                                                            <li><i class="fa fa-angle-right pink-color"></i> <a
                                                                        href="cng-pw.html">Change Password</a></li>
                                                            <li><i class="fa fa-angle-right pink-color"></i> <a
                                                                        href="address-book.html">Address Books</a>
                                                            </li>
                                                            <li><i class="fa fa-angle-right pink-color"></i> <a
                                                                        href="order-history.html">Order History</a>
                                                            </li>
                                                            <li><i class="fa fa-angle-right pink-color"></i> <a
                                                                        href="review-rating.html">Reviews and
                                                                    Ratings</a></li>
                                                            <li><i class="fa fa-angle-right pink-color"></i> <a
                                                                        href="return.html">Returns Requests</a></li>
                                                            <li><i class="fa fa-angle-right pink-color"></i> <a
                                                                        href="newsletter.html">Newsletter</a></li>
                                                            <li><i class="fa fa-angle-right pink-color"></i> <a
                                                                        href="myaccount-leftsidebar.html">Left
                                                                    Sidebar</a></li>
                                                        </ul>
                                                    </div>
                                                </div>
