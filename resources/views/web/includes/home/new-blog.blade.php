            ...
            <div class="blog-wrap space-top-35">
                ...
                <div class="row">
                    <div class="col-md-4 col-sm-6">
                        <div class="post-wrap">
                            <div class="post-media">
                                <img src="{{asset('web/assets/img/blog/blog-1.jpg')}}" alt=" ">
                                <div class="blog-new">
                            ...
                            <div class="bg2-with-mask green-box-shadow">
                                ...
                                <div class="post-content">
                                    ...
                                    <div class="post-detail">
                                        <p>Phasellus rhoncus quis nunc vitae dapibus. Integer vehicula urna ut nisl
                                            ullamcorper.</p>
                                    </div>
                                    <div class="read-more">
                                        <a class="title-link" href="#"> Read More <i class="fa fa-caret-right"></i>
                                        </a>
                                    </div>
                                </div>
                            </div>
                    ...
                    <div class="col-md-4 col-sm-6">
                        <div class="post-wrap">
                            <div class="post-media">
                                <img src="{{asset('web/assets/img/blog/blog-2.jpg')}}" alt=" ">
                                <div class="blog-new">
                    ...
                    <div class="col-md-4 col-sm-6">
                        <div class="post-wrap">
                            <div class="post-media">
                                <img src="{{asset('web/assets/img/blog/blog-3.jpg')}}" alt=" ">
                                <div class="blog-new">
