                        ...
                        <div class="address">
                            <ul>
                                ...
                                <li><i class="fa fa-envelope blue-color"></i> <a
                                            href="mailto:baby.kidsstore@example.com"> <span> baby.kidsstore@example.com </span>
                                    </a></li>
                                <li><i class="fa fa-map-marker blue-color"></i> <span>121 King St </span> <span>Melbourne VIC 3000 Australi.</span>
                                </li>
                            </ul>
                        </div>
                ...
                <aside class="col-md-3 col-sm-6">
                    <div class="footer-widget space-bottom-35">
                        ...
                        <ul>
                            ...
                            <li><a href="#"> <i class="fa fa-angle-right pink-color"></i> Personal Information</a>
                            </li>
