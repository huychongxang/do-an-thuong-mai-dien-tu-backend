...
@section('title_page','Sửa danh mục')
@push('styles')
...
@section('content')
    <div class="row">
        <div class="col-lg-12">
            <form method="post" action="{{route(env('ADMIN_PATH','cms').'.categories.update',$category->id)}}">
                @csrf
                @method('PUT')
